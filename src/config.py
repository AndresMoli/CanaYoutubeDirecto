...
def load_config() -> Config:
    return Config(
        ...
        keyword_misa_10=os.getenv("YT_KEYWORD_MISA_10", "Misa de 10h"),
        keyword_misa_12=os.getenv("YT_KEYWORD_MISA_12", "Misa de 12h"),
        keyword_misa_20=os.getenv("YT_KEYWORD_MISA_20", "Misa de 20h"),
